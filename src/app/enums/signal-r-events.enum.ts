export enum SignalREvents {
    MatchObjectCreated = 'match_object_created',
    MatchStatusAborted = 'match_status_aborted',
    MatchStatusCancelled = 'match_status_cancelled',
    ...
    ChallangeStatsEvent = 'challangeStats'
}
